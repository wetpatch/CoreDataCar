...
class DataController: ObservableObject {
    ...
    func addCarExpense(expensedate: Date, expensedetail: String, expensecost: Double, regnum: String, context: NSManagedObjectContext) {
    ...
    func addFuelCost(litres: Double, cost: Double, mileage: Int64, selectedDate: Date, fuelcost: Double, context: NSManagedObjectContext) {
    ...
    func addCarInsurance(comment: String, contact: String, cost: Int64, selectedDate: Date, name: String, policyno: String, context: NSManagedObjectContext) {
